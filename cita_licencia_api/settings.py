"""
Django settings for cita_licencia_api project.
...
SECRET_KEY = 'django-insecure-#6k4bh(z%3_vcckyt5du7$y(5lv7a@^45)=001h7t(lk+a(3_s'
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'cita_licencia.apps.CitaLicenciaConfig',
]
...
ROOT_URLCONF = 'cita_licencia_api.urls'
...
WSGI_APPLICATION = 'cita_licencia_api.wsgi.application'
